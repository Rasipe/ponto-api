...
public class PontoController {
    ...
    public ResponseEntity<List<Ponto>> buscarUltimosPontos(@PathVariable Long funcionarioId, @RequestParam int quantidade) {
        List<Ponto> ultimosPontos = pontoService.buscarUltimosPontos(funcionarioId, quantidade);
